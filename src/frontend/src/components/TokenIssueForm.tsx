...
interface State {
  name: string;
  nameStatus: { code: number; msg: string };
  symbol: string;
  symbolStatus: { code: number; msg: string };
  supply: string;
  supplyStatus: { code: number; msg: string };
  decimals: string;
  decimalsStatus: { code: number; msg: string };
  showCard: boolean;
  loading: boolean;
}
class TokenIssueForm extends Component<{}, State> {
  constructor(props: {}) {
    super(props);
    this.state = {
      name: "",
  ...
  supplyOnChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    this.setState({
      supply: val,
      supplyStatus:
        val && parseInt(val) > 0 ? { code: 1, msg: "" } : { code: 0, msg: "" },
      showCard: true,
    });
  };
  decimalsOnChange = (e: ChangeEvent<HTMLInputElement>) => {
    const val = e.target.value;
    const reg = new RegExp("^[0-9]*$");
    if (val && !reg.test(val)) return;
    this.setState({
        ...
        <div className="form-wrap">
          <div className="form">
            <label>
              ...
              >
                ...
                <path
                  id="减去_5"
                  data-name="减去 5"
                  d="M-1981,18a9.01,9.01,0,0,1-9-9,9.01,9.01,0,0,1,9-9,9.01,9.01,0,0,1,9,9A9.01,9.01,0,0,1-1981,18Zm0-14a5.006,5.006,0,0,0-5,5,5.006,5.006,0,0,0,5,5,5.006,5.006,0,0,0,5-5A5.006,5.006,0,0,0-1981,4Z"
            ...
            <Input
              ...
              plus={() =>
                this.setState({
                  supply: (parseInt(this.state.supply || "0") + 1).toString(),
                })
              }
              minus={() =>
                this.setState({
            ...
            <Input
              ...
              plus={() =>
                this.setState({
                  decimals: (
                    parseInt(this.state.decimals || "0") + 1
                  ).toString(),
                })
              }
              minus={() =>
          ...
          <div className={classNames("card", { ac: this.state.showCard })}>
              ...
              >
                ...
                >
                  ...
                  <g
                    id="组_60"
                    data-name="组 60"
                    transform="translate(3453.33 3368.313)"
                  >
                    <path
                      id="路径_68"
                      data-name="路径 68"
                      d="M3510.507,3368.313h-10.519c29.655,4.331,52.41,27.872,52.931,56.426q.013.5.014,1v0h0q0,.5-.014,1c-.522,28.554-23.275,52.094-52.931,56.425h10.519c34.261,0,62.036-25.711,62.036-57.427h0C3572.543,3394.024,3544.769,3368.313,3510.507,3368.313Z"
                  ...
                  <path
                    id="路径_69"
                    data-name="路径 69"
                    d="M3425.885,3386.26c0,27.688,16.257,42.657,16.257,61.8s-16.257,29.729-16.257,39.756Z"
                    transform="translate(0 -11.3)"
            ...
            <div className="accessory-2">
              <div className="wrap">
                <span
                  className={classNames("name", { muted: !this.state.name })}
                >
                  {this.state.name || "---"}
                </span>
                ...
                <span
                  className={classNames("demical", {
                    muted: !this.state.decimals,
                  })}
                >
                  {this.state.decimals || "---"}
                </span>
            ...
            {this.state.loading ? (
              ...
              <button
                ...
                onClick={this.submit}
                disabled={
                  this.state.nameStatus.code +
                    this.state.symbolStatus.code +
                    this.state.supplyStatus.code +
                    this.state.decimalsStatus.code !==
                  4
                }
              >
                <span>Issue</span>
  ...
  return (
    <div className="input-group">
        ...
        {withNumberModifier ? (
          <div className="number-modifier">
            <button
              ...
              onClick={plus}
              disabled={
                max && parseInt(value || "0") >= parseInt(max) ? true : false
              }
            >
            ...
            <button
              ...
              onClick={minus}
              disabled={
                min && parseInt(value || "0") <= parseInt(min) ? true : false
              }
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 12">
                <path
      ...
      <div className="status">
        {status.code === 1 ? <Icon name="check-alt" /> : null}
